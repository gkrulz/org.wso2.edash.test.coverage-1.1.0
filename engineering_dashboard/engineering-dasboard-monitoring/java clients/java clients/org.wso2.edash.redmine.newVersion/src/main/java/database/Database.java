...
*/
            ...
            String tempQuery = "INSERT INTO REDMINE_ISSUES_DETAILS (project_name,assignee,realese_name,issue_id,milestone,"
                    + "issue_subject,issue_description,issue_status,issue_edays,issue_adays) VALUES(?,?,?,?,?,?,?,?,?,?)";


            String query = "INSERT INTO REDMINE_ISSUES_DETAILS (project_name,assignee,realese_name,issue_id,milestone,"
                    + "issue_subject,issue_status,issue_edays,issue_adays) VALUES(?,?,?,?,?,?,?,?,?)";
            ...
            //pstmt.setString(7, issue.getDescription());
            pstmt.setString(7, issue.getStatus());
            pstmt.setDouble(8, issue.getEstmatedHours() / 24);
            pstmt.setInt(9, issue.getActual_open());
            ...
            con.close();
            // end of Issue insertion for loop
